...
extract_txt = EnemPDFextractor("TXT", ignore_questions_with_images=False)
...
extract_txt.extract_pdf("pdfs_enem/2022/2022_PV_impresso_D2_CD7.pdf","pdfs_enem/2022/2022_GB_impresso_D2_CD7.pdf","output_fitz__imagens_unificado2",)
